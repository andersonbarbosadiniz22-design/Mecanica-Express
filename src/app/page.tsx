    ...
    <main className="min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-white/5 py-4 px-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <Button size="sm" className="bg-primary hover:bg-primary/90 text-white font-bold px-4 rounded-md text-xs uppercase hidden sm:flex">
            QUERO MEU ACESSO
          </Button>
        </div>
      </nav>
      ...
      <section className="py-24 px-4 bg-primary text-center">
        <div className="container mx-auto max-w-2xl">
          ...
          <Button size="lg" className="bg-white hover:bg-white/90 text-primary font-black h-20 px-12 text-2xl rounded-2xl uppercase shadow-2xl transition-transform active:scale-95">
